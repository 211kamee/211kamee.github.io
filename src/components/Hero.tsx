...
export default function Hero() {
	return (
		...
		>
			...
			<p className="font-focus text-2xl sm:text-3xl lg:text-4xl xl:text-6xl 2xl:text-8xl text-theme font-outline text-center">
				Aspiring
				<span className="block text-foreground ml-2 sm:ml-4 lg:ml-8">Developer</span>
			</p>
				<Owl className="opacity-50 absolute h-full top-1/2 right-0 -translate-y-1/2 -translate-x-1/2" />
