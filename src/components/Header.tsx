...
export default function Header() {
	...
	return (
		<header
			ref={headerRef}
			className="fixed top-0 left-1/2 -translate-x-1/2 max-w-[90%] xl:max-w-[1223px] w-full z-50 select-none"
		>
			<nav className="flex justify-between items-center px-6 py-4 rounded-2xl bg-gradient-to-r from-[#d9d9d91f] to-[#7373731f] mt-4 sm:mt-8 backdrop-blur-md border border-x-2 border-muted-foreground">
				<a href="#hero">
